...
// Create a new hotel
router.post('/hotels', authenticateToken, authorizeAdmin, hotelController.create);

// Get a specific hotel by ID
router.get('/getHotelsById/:id', authenticateToken, authorizeUser, hotelController.getById);

// Update a specific hotel by ID
router.put('/updateHotels/:id', authenticateToken, authorizeAdmin, hotelController.update);
