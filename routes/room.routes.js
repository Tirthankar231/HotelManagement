...
// Create a new room
router.post('/createRooms', authenticateToken, authorizeAdmin, roomController.create);

// Get a specific room by ID
router.get('/getRoomsById/:id', authenticateToken, authorizeUser, roomController.getById);

// Update a specific room by ID
router.put('/updateRooms/:id', authenticateToken, authorizeAdmin, roomController.update);
